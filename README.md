...
REPETIR hasta que todo cuadre:
    ...
    # con redondeo Webster/Sainte-Laguë y votos ajustados por el multiplicador
    PARA CADA provincia:
        votos_ajustados = votos × multiplicador_partido
        asignar_escaños_provincia = Webster(votos_ajustados, escaños_provincia)
...
|---|---|---|
| **Votos sin escaño en su provincia** | ~1.9M (7.9%) | ~1.3M (5.4%) |
