...
export const historicalParties: { [key: string]: { name: string; color: string } } = {
  ...
  // Variantes de nombre usadas en distintas elecciones
  "C's": { name: "Ciudadanos", color: "#eb6109" },
  "EH Bildu": { name: "EH Bildu", color: "#b5cf00" },
  "EAJ-PNV": { name: "Partido Nacionalista Vasco", color: "#008000" },
  "ERC-CATSÍ": { name: "Esquerra Republicana", color: "#ffb400" },
  "ECP": { name: "En Comú Podem", color: "#6a2c70" },
  "En Comú Podem": { name: "En Comú Podem", color: "#6a2c70" },
  "JxCat": { name: "Junts per Catalunya", color: "#00b2a9" },
  "JXC": { name: "Junts per Catalunya", color: "#00b2a9" },
  "Más País": { name: "Más País", color: "#00a85a" },
  "Compromís": { name: "Compromís", color: "#d25d10" },
  "PODEMOS-IU-EQUO": { name: "Unidos Podemos", color: "#6a2c70" },
  "PODEMOS-COMPROMÍS-EUPV": { name: "Podemos-Compromís", color: "#6a2c70" },
  "PODEMOS-EN MAREA-ANOVA-EU": { name: "En Marea", color: "#6a2c70" },
  "CCa-NC": { name: "Coalición Canaria", color: "#ffcc00" },
  "CCa-PNC": { name: "Coalición Canaria", color: "#ffcc00" },
  "CCa": { name: "Coalición Canaria", color: "#ffcc00" },
  "NA+": { name: "Navarra Suma", color: "#0070b8" },
  "Navarra Suma": { name: "Navarra Suma", color: "#0070b8" },
  "PACMA": { name: "PACMA", color: "#00945a" },
  "BNG-NÓS": { name: "BNG-Nós", color: "#76b6de" },
